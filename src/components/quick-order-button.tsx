  ...
  return (
    <>
      <button
        ...
        className="inline-flex h-11 w-full min-w-0 items-center justify-center rounded-full border border-lime bg-lime/10 px-3 text-sm font-bold text-petrol transition hover:bg-lime/20 sm:px-5"
      >
        Купить в 1 клик
      </button>
      {open ? (
